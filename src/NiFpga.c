 ...
 */
static NiFpga_Status(NiFpga_CCall* NiFpga_open)(const char* path,
...
{
    const NiFpga_Status result =
        NiFpga_open ? NiFpga_open(path, signature, resource, attribute, session)
...
static NiFpga_Status(NiFpga_CCall* NiFpga_close)(NiFpga_Session session,
 ...
 */
static NiFpga_Status(NiFpga_CCall* NiFpga_run)(NiFpga_Session session,
                                               uint32_t attribute) = NULL;

NiFpga_Status NiFpga_Run(NiFpga_Session session, uint32_t attribute)
{
    return NiFpga_run ? NiFpga_run(session, attribute)
                      : NiFpga_Status_ResourceNotInitialized;
}
...
{
    return NiFpga_abort ? NiFpga_abort(session)
                        : NiFpga_Status_ResourceNotInitialized;
}
...
{
    return NiFpga_reset ? NiFpga_reset(session)
                        : NiFpga_Status_ResourceNotInitialized;
}

static NiFpga_Status(NiFpga_CCall* NiFpga_download)(NiFpga_Session session) =
    NULL;

NiFpga_Status NiFpga_Download(NiFpga_Session session)
{
    return NiFpga_download ? NiFpga_download(session)
                           : NiFpga_Status_ResourceNotInitialized;
}
 ...
 */
static NiFpga_Status(NiFpga_CCall* NiFpga_readBool)(NiFpga_Session session,
                                                    uint32_t indicator,
...
static NiFpga_Status(NiFpga_CCall* NiFpga_readI8)(NiFpga_Session session,
                                                  uint32_t indicator,
                                                  int8_t* value) = NULL;
...
NiFpga_Status NiFpga_ReadI8(NiFpga_Session session,
                            ...
                            int8_t* value)
{
    return NiFpga_readI8 ? NiFpga_readI8(session, indicator, value)
                         : NiFpga_Status_ResourceNotInitialized;
}

static NiFpga_Status(NiFpga_CCall* NiFpga_readU8)(NiFpga_Session session,
                                                  uint32_t indicator,
                                                  uint8_t* value) = NULL;
...
NiFpga_Status NiFpga_ReadU8(NiFpga_Session session,
                            ...
                            uint8_t* value)
{
    return NiFpga_readU8 ? NiFpga_readU8(session, indicator, value)
                         : NiFpga_Status_ResourceNotInitialized;
}

static NiFpga_Status(NiFpga_CCall* NiFpga_readI16)(NiFpga_Session session,
                                                   uint32_t indicator,
                                                   int16_t* value) = NULL;
...
NiFpga_Status NiFpga_ReadI16(NiFpga_Session session,
                             ...
                             int16_t* value)
{
    return NiFpga_readI16 ? NiFpga_readI16(session, indicator, value)
                          : NiFpga_Status_ResourceNotInitialized;
}

static NiFpga_Status(NiFpga_CCall* NiFpga_readU16)(NiFpga_Session session,
                                                   uint32_t indicator,
                                                   uint16_t* value) = NULL;
...
NiFpga_Status NiFpga_ReadU16(NiFpga_Session session,
                             ...
                             uint16_t* value)
{
    return NiFpga_readU16 ? NiFpga_readU16(session, indicator, value)
                          : NiFpga_Status_ResourceNotInitialized;
}

static NiFpga_Status(NiFpga_CCall* NiFpga_readI32)(NiFpga_Session session,
                                                   uint32_t indicator,
                                                   int32_t* value) = NULL;
...
NiFpga_Status NiFpga_ReadI32(NiFpga_Session session,
                             ...
                             int32_t* value)
{
    return NiFpga_readI32 ? NiFpga_readI32(session, indicator, value)
                          : NiFpga_Status_ResourceNotInitialized;
}

static NiFpga_Status(NiFpga_CCall* NiFpga_readU32)(NiFpga_Session session,
                                                   uint32_t indicator,
                                                   uint32_t* value) = NULL;
...
NiFpga_Status NiFpga_ReadU32(NiFpga_Session session,
                             ...
                             uint32_t* value)
{
    return NiFpga_readU32 ? NiFpga_readU32(session, indicator, value)
                          : NiFpga_Status_ResourceNotInitialized;
}

static NiFpga_Status(NiFpga_CCall* NiFpga_readI64)(NiFpga_Session session,
                                                   uint32_t indicator,
                                                   int64_t* value) = NULL;
...
NiFpga_Status NiFpga_ReadI64(NiFpga_Session session,
                             ...
                             int64_t* value)
{
    return NiFpga_readI64 ? NiFpga_readI64(session, indicator, value)
                          : NiFpga_Status_ResourceNotInitialized;
}

static NiFpga_Status(NiFpga_CCall* NiFpga_readU64)(NiFpga_Session session,
                                                   uint32_t indicator,
                                                   uint64_t* value) = NULL;
...
NiFpga_Status NiFpga_ReadU64(NiFpga_Session session,
                             ...
                             uint64_t* value)
{
    return NiFpga_readU64 ? NiFpga_readU64(session, indicator, value)
                          : NiFpga_Status_ResourceNotInitialized;
}
 ...
 */
static NiFpga_Status(NiFpga_CCall* NiFpga_writeBool)(NiFpga_Session session,
                                                     uint32_t control,
                                                     NiFpga_Bool value) = NULL;
...
static NiFpga_Status(NiFpga_CCall* NiFpga_writeI8)(NiFpga_Session session,
                                                   uint32_t control,
                                                   int8_t value) = NULL;
...
NiFpga_Status NiFpga_WriteI8(NiFpga_Session session,
                             ...
                             int8_t value)
{
    return NiFpga_writeI8 ? NiFpga_writeI8(session, control, value)
                          : NiFpga_Status_ResourceNotInitialized;
}

static NiFpga_Status(NiFpga_CCall* NiFpga_writeU8)(NiFpga_Session session,
                                                   uint32_t control,
                                                   uint8_t value) = NULL;
...
NiFpga_Status NiFpga_WriteU8(NiFpga_Session session,
                             ...
                             uint8_t value)
{
    return NiFpga_writeU8 ? NiFpga_writeU8(session, control, value)
                          : NiFpga_Status_ResourceNotInitialized;
}

static NiFpga_Status(NiFpga_CCall* NiFpga_writeI16)(NiFpga_Session session,
                                                    uint32_t control,
                                                    int16_t value) = NULL;
...
NiFpga_Status NiFpga_WriteI16(NiFpga_Session session,
                              ...
                              int16_t value)
{
    return NiFpga_writeI16 ? NiFpga_writeI16(session, control, value)
                           : NiFpga_Status_ResourceNotInitialized;
}

static NiFpga_Status(NiFpga_CCall* NiFpga_writeU16)(NiFpga_Session session,
                                                    uint32_t control,
                                                    uint16_t value) = NULL;
...
NiFpga_Status NiFpga_WriteU16(NiFpga_Session session,
                              ...
                              uint16_t value)
{
    return NiFpga_writeU16 ? NiFpga_writeU16(session, control, value)
                           : NiFpga_Status_ResourceNotInitialized;
}

static NiFpga_Status(NiFpga_CCall* NiFpga_writeI32)(NiFpga_Session session,
                                                    uint32_t control,
                                                    int32_t value) = NULL;
...
NiFpga_Status NiFpga_WriteI32(NiFpga_Session session,
                              ...
                              int32_t value)
{
    return NiFpga_writeI32 ? NiFpga_writeI32(session, control, value)
                           : NiFpga_Status_ResourceNotInitialized;
}

static NiFpga_Status(NiFpga_CCall* NiFpga_writeU32)(NiFpga_Session session,
                                                    uint32_t control,
                                                    uint32_t value) = NULL;
...
NiFpga_Status NiFpga_WriteU32(NiFpga_Session session,
                              ...
                              uint32_t value)
{
    return NiFpga_writeU32 ? NiFpga_writeU32(session, control, value)
                           : NiFpga_Status_ResourceNotInitialized;
}

static NiFpga_Status(NiFpga_CCall* NiFpga_writeI64)(NiFpga_Session session,
                                                    uint32_t control,
                                                    int64_t value) = NULL;
...
NiFpga_Status NiFpga_WriteI64(NiFpga_Session session,
                              ...
                              int64_t value)
{
    return NiFpga_writeI64 ? NiFpga_writeI64(session, control, value)
                           : NiFpga_Status_ResourceNotInitialized;
}

static NiFpga_Status(NiFpga_CCall* NiFpga_writeU64)(NiFpga_Session session,
                                                    uint32_t control,
                                                    uint64_t value) = NULL;
...
NiFpga_Status NiFpga_WriteU64(NiFpga_Session session,
                              ...
                              uint64_t value)
{
    return NiFpga_writeU64 ? NiFpga_writeU64(session, control, value)
                           : NiFpga_Status_ResourceNotInitialized;
}
 ...
 */
static NiFpga_Status(NiFpga_CCall* NiFpga_readArrayBool)(NiFpga_Session session,
                                                         uint32_t indicator,
                                                         NiFpga_Bool* array,
                                                         size_t size) = NULL;
...
static NiFpga_Status(NiFpga_CCall* NiFpga_readArrayI8)(NiFpga_Session session,
                                                       uint32_t indicator,
                                                       int8_t* array,
                                                       size_t size) = NULL;
...
static NiFpga_Status(NiFpga_CCall* NiFpga_readArrayU8)(NiFpga_Session session,
                                                       uint32_t indicator,
                                                       uint8_t* array,
                                                       size_t size) = NULL;
...
static NiFpga_Status(NiFpga_CCall* NiFpga_readArrayI16)(NiFpga_Session session,
                                                        uint32_t indicator,
                                                        int16_t* array,
                                                        size_t size) = NULL;
...
static NiFpga_Status(NiFpga_CCall* NiFpga_readArrayU16)(NiFpga_Session session,
                                                        uint32_t indicator,
                                                        uint16_t* array,
                                                        size_t size) = NULL;
...
static NiFpga_Status(NiFpga_CCall* NiFpga_readArrayI32)(NiFpga_Session session,
                                                        uint32_t indicator,
                                                        int32_t* array,
                                                        size_t size) = NULL;
...
static NiFpga_Status(NiFpga_CCall* NiFpga_readArrayU32)(NiFpga_Session session,
                                                        uint32_t indicator,
                                                        uint32_t* array,
                                                        size_t size) = NULL;
...
static NiFpga_Status(NiFpga_CCall* NiFpga_readArrayI64)(NiFpga_Session session,
                                                        uint32_t indicator,
                                                        int64_t* array,
                                                        size_t size) = NULL;
...
static NiFpga_Status(NiFpga_CCall* NiFpga_readArrayU64)(NiFpga_Session session,
                                                        uint32_t indicator,
                                                        uint64_t* array,
                                                        size_t size) = NULL;
...
static NiFpga_Status(NiFpga_CCall* NiFpga_writeArrayI8)(NiFpga_Session session,
                                                        uint32_t control,
                                                        const int8_t* array,
                                                        size_t size) = NULL;
...
static NiFpga_Status(NiFpga_CCall* NiFpga_writeArrayU8)(NiFpga_Session session,
                                                        uint32_t control,
                                                        const uint8_t* array,
                                                        size_t size) = NULL;
...
static NiFpga_Status(NiFpga_CCall* NiFpga_writeArrayI16)(NiFpga_Session session,
                                                         uint32_t control,
                                                         const int16_t* array,
                                                         size_t size) = NULL;
...
static NiFpga_Status(NiFpga_CCall* NiFpga_writeArrayU16)(NiFpga_Session session,
                                                         uint32_t control,
...
static NiFpga_Status(NiFpga_CCall* NiFpga_writeArrayI32)(NiFpga_Session session,
                                                         uint32_t control,
                                                         const int32_t* array,
                                                         size_t size) = NULL;
...
static NiFpga_Status(NiFpga_CCall* NiFpga_writeArrayU32)(NiFpga_Session session,
                                                         uint32_t control,
...
static NiFpga_Status(NiFpga_CCall* NiFpga_writeArrayI64)(NiFpga_Session session,
                                                         uint32_t control,
                                                         const int64_t* array,
                                                         size_t size) = NULL;
...
static NiFpga_Status(NiFpga_CCall* NiFpga_writeArrayU64)(NiFpga_Session session,
                                                         uint32_t control,
...
static NiFpga_Status(NiFpga_CCall* NiFpga_reserveIrqContext)(
    NiFpga_Session session, NiFpga_IrqContext* context) = NULL;

NiFpga_Status NiFpga_ReserveIrqContext(NiFpga_Session session,
                                       NiFpga_IrqContext* context)
{
    const NiFpga_Status result =
        NiFpga_reserveIrqContext ? NiFpga_reserveIrqContext(session, context)
                                 : NiFpga_Status_ResourceNotInitialized;
#if NiFpga_CviResourceTracking
    if (NiFpga_acquireCviResource && NiFpga_IsNotError(result))
...
static NiFpga_Status(NiFpga_CCall* NiFpga_waitOnIrqs)(NiFpga_Session session,
                                                      NiFpga_IrqContext context,
                                                      uint32_t irqs,
                                                      uint32_t timeout,
                                ...
                                NiFpga_Bool* timedOut)
{
    return NiFpga_waitOnIrqs
               ? NiFpga_waitOnIrqs(
                     session, context, irqs, timeout, irqsAsserted, timedOut)
               : NiFpga_Status_ResourceNotInitialized;
}

static NiFpga_Status(NiFpga_CCall* NiFpga_acknowledgeIrqs)(
    NiFpga_Session session, uint32_t irqs) = NULL;
 ...
 */
static NiFpga_Status(NiFpga_CCall* NiFpga_configureFifo)(NiFpga_Session session,
                                                         uint32_t fifo,
                                                         size_t depth) = NULL;
                                    ...
                                    size_t* actualDepth)
{
    return NiFpga_configureFifo2
               ? NiFpga_configureFifo2(
                     session, fifo, requestedDepth, actualDepth)
               : NiFpga_Status_ResourceNotInitialized;
}

static NiFpga_Status(NiFpga_CCall* NiFpga_startFifo)(NiFpga_Session session,
                                                     uint32_t fifo) = NULL;

NiFpga_Status NiFpga_StartFifo(NiFpga_Session session, uint32_t fifo)
{
    return NiFpga_startFifo ? NiFpga_startFifo(session, fifo)
                            : NiFpga_Status_ResourceNotInitialized;
}

static NiFpga_Status(NiFpga_CCall* NiFpga_stopFifo)(NiFpga_Session session,
                                                    uint32_t fifo) = NULL;

NiFpga_Status NiFpga_StopFifo(NiFpga_Session session, uint32_t fifo)
{
    return NiFpga_stopFifo ? NiFpga_stopFifo(session, fifo)
                           : NiFpga_Status_ResourceNotInitialized;
}
...
{
    return NiFpga_readFifoBool ? NiFpga_readFifoBool(session,
                                                     fifo,
                                                     data,
                                                     numberOfElements,
                                                     timeout,
...
NiFpga_Status NiFpga_ReadFifoI8(NiFpga_Session session,
                                ...
                                size_t* elementsRemaining)
{
    return NiFpga_readFifoI8 ? NiFpga_readFifoI8(session,
                                                 fifo,
                                                 data,
                                                 numberOfElements,
                                                 timeout,
...
NiFpga_Status NiFpga_ReadFifoU8(NiFpga_Session session,
                                ...
                                size_t* elementsRemaining)
{
    return NiFpga_readFifoU8 ? NiFpga_readFifoU8(session,
                                                 fifo,
                                                 data,
                                                 numberOfElements,
                                                 timeout,
...
NiFpga_Status NiFpga_ReadFifoI16(NiFpga_Session session,
                                 ...
                                 size_t* elementsRemaining)
{
    return NiFpga_readFifoI16 ? NiFpga_readFifoI16(session,
                                                   fifo,
                                                   data,
                                                   numberOfElements,
                                                   timeout,
...
NiFpga_Status NiFpga_ReadFifoU16(NiFpga_Session session,
                                 ...
                                 size_t* elementsRemaining)
{
    return NiFpga_readFifoU16 ? NiFpga_readFifoU16(session,
                                                   fifo,
                                                   data,
                                                   numberOfElements,
                                                   timeout,
...
NiFpga_Status NiFpga_ReadFifoI32(NiFpga_Session session,
                                 ...
                                 size_t* elementsRemaining)
{
    return NiFpga_readFifoI32 ? NiFpga_readFifoI32(session,
                                                   fifo,
                                                   data,
                                                   numberOfElements,
                                                   timeout,
...
NiFpga_Status NiFpga_ReadFifoU32(NiFpga_Session session,
                                 ...
                                 size_t* elementsRemaining)
{
    return NiFpga_readFifoU32 ? NiFpga_readFifoU32(session,
                                                   fifo,
                                                   data,
                                                   numberOfElements,
                                                   timeout,
...
NiFpga_Status NiFpga_ReadFifoI64(NiFpga_Session session,
                                 ...
                                 size_t* elementsRemaining)
{
    return NiFpga_readFifoI64 ? NiFpga_readFifoI64(session,
                                                   fifo,
                                                   data,
                                                   numberOfElements,
                                                   timeout,
...
NiFpga_Status NiFpga_ReadFifoU64(NiFpga_Session session,
                                 ...
                                 size_t* elementsRemaining)
{
    return NiFpga_readFifoU64 ? NiFpga_readFifoU64(session,
                                                   fifo,
                                                   data,
                                                   numberOfElements,
                                                   timeout,
...
{
    return NiFpga_writeFifoBool ? NiFpga_writeFifoBool(session,
                                                       fifo,
                                                       data,
                                                       numberOfElements,
                                                       timeout,
...
NiFpga_Status NiFpga_WriteFifoI8(NiFpga_Session session,
                                 ...
                                 size_t* emptyElementsRemaining)
{
    return NiFpga_writeFifoI8 ? NiFpga_writeFifoI8(session,
                                                   fifo,
                                                   data,
                                                   numberOfElements,
                                                   timeout,
...
NiFpga_Status NiFpga_WriteFifoU8(NiFpga_Session session,
                                 ...
                                 size_t* emptyElementsRemaining)
{
    return NiFpga_writeFifoU8 ? NiFpga_writeFifoU8(session,
                                                   fifo,
                                                   data,
                                                   numberOfElements,
                                                   timeout,
...
NiFpga_Status NiFpga_WriteFifoI16(NiFpga_Session session,
                                  ...
                                  size_t* emptyElementsRemaining)
{
    return NiFpga_writeFifoI16 ? NiFpga_writeFifoI16(session,
                                                     fifo,
                                                     data,
                                                     numberOfElements,
                                                     timeout,
...
NiFpga_Status NiFpga_WriteFifoU16(NiFpga_Session session,
                                  ...
                                  size_t* emptyElementsRemaining)
{
    return NiFpga_writeFifoU16 ? NiFpga_writeFifoU16(session,
                                                     fifo,
                                                     data,
                                                     numberOfElements,
                                                     timeout,
...
NiFpga_Status NiFpga_WriteFifoI32(NiFpga_Session session,
                                  ...
                                  size_t* emptyElementsRemaining)
{
    return NiFpga_writeFifoI32 ? NiFpga_writeFifoI32(session,
                                                     fifo,
                                                     data,
                                                     numberOfElements,
                                                     timeout,
...
NiFpga_Status NiFpga_WriteFifoU32(NiFpga_Session session,
                                  ...
                                  size_t* emptyElementsRemaining)
{
    return NiFpga_writeFifoU32 ? NiFpga_writeFifoU32(session,
                                                     fifo,
                                                     data,
                                                     numberOfElements,
                                                     timeout,
...
NiFpga_Status NiFpga_WriteFifoI64(NiFpga_Session session,
                                  ...
                                  size_t* emptyElementsRemaining)
{
    return NiFpga_writeFifoI64 ? NiFpga_writeFifoI64(session,
                                                     fifo,
                                                     data,
                                                     numberOfElements,
                                                     timeout,
...
NiFpga_Status NiFpga_WriteFifoU64(NiFpga_Session session,
                                  ...
                                  size_t* emptyElementsRemaining)
{
    return NiFpga_writeFifoU64 ? NiFpga_writeFifoU64(session,
                                                     fifo,
                                                     data,
                                                     numberOfElements,
                                                     timeout,
...
static NiFpga_Status(NiFpga_CCall* NiFpga_releaseFifoElements)(
    NiFpga_Session session, uint32_t fifo, size_t elements) = NULL;
...
static NiFpga_Status(NiFpga_CCall* NiFpga_getPeerToPeerFifoEndpoint)(
    NiFpga_Session session, uint32_t fifo, uint32_t* endpoint) = NULL;
...
static const struct
{
    ...
    {"NiFpgaDll_UnreserveIrqContext",
     (void**)(void*)&NiFpga_unreserveIrqContext},
    ...
    {"NiFpgaDll_AcquireFifoReadElementsBool",
     (void**)(void*)&NiFpga_acquireFifoReadElementsBool},
    {"NiFpgaDll_AcquireFifoReadElementsI8",
     (void**)(void*)&NiFpga_acquireFifoReadElementsI8},
    {"NiFpgaDll_AcquireFifoReadElementsU8",
     (void**)(void*)&NiFpga_acquireFifoReadElementsU8},
    {"NiFpgaDll_AcquireFifoReadElementsI16",
     (void**)(void*)&NiFpga_acquireFifoReadElementsI16},
    {"NiFpgaDll_AcquireFifoReadElementsU16",
     (void**)(void*)&NiFpga_acquireFifoReadElementsU16},
    {"NiFpgaDll_AcquireFifoReadElementsI32",
     (void**)(void*)&NiFpga_acquireFifoReadElementsI32},
    {"NiFpgaDll_AcquireFifoReadElementsU32",
     (void**)(void*)&NiFpga_acquireFifoReadElementsU32},
    {"NiFpgaDll_AcquireFifoReadElementsI64",
     (void**)(void*)&NiFpga_acquireFifoReadElementsI64},
    {"NiFpgaDll_AcquireFifoReadElementsU64",
     (void**)(void*)&NiFpga_acquireFifoReadElementsU64},
    {"NiFpgaDll_AcquireFifoWriteElementsBool",
     (void**)(void*)&NiFpga_acquireFifoWriteElementsBool},
    {"NiFpgaDll_AcquireFifoWriteElementsI8",
     (void**)(void*)&NiFpga_acquireFifoWriteElementsI8},
    {"NiFpgaDll_AcquireFifoWriteElementsU8",
     (void**)(void*)&NiFpga_acquireFifoWriteElementsU8},
    {"NiFpgaDll_AcquireFifoWriteElementsI16",
     (void**)(void*)&NiFpga_acquireFifoWriteElementsI16},
    {"NiFpgaDll_AcquireFifoWriteElementsU16",
     (void**)(void*)&NiFpga_acquireFifoWriteElementsU16},
    {"NiFpgaDll_AcquireFifoWriteElementsI32",
     (void**)(void*)&NiFpga_acquireFifoWriteElementsI32},
    {"NiFpgaDll_AcquireFifoWriteElementsU32",
     (void**)(void*)&NiFpga_acquireFifoWriteElementsU32},
    {"NiFpgaDll_AcquireFifoWriteElementsI64",
     (void**)(void*)&NiFpga_acquireFifoWriteElementsI64},
    {"NiFpgaDll_AcquireFifoWriteElementsU64",
     (void**)(void*)&NiFpga_acquireFifoWriteElementsU64},
    {"NiFpgaDll_ReleaseFifoElements",
     (void**)(void*)&NiFpga_releaseFifoElements},
    {"NiFpgaDll_GetPeerToPeerFifoEndpoint",
     (void**)(void*)&NiFpga_getPeerToPeerFifoEndpoint},
    {NULL, NULL}};
...
#error
        ...
        for (i = 0; NiFpga_functions[i].name; i++)
        {
            ...
            *address = GetProcAddress(NiFpga_library, name);
            if (!*address) return NiFpga_Status_VersionMismatch;
#elif NiFpga_VxWorks
            SYM_TYPE type;
            if (symFindByName(sysSymTbl, (char*)name, (char**)address, &type) !=
                OK)
...
#if NiFpga_CviResourceTracking
        {
            ...
            if (engine)
            {
                NiFpga_acquireCviResource =
                    (NiFpga_AcquireCviResource)GetProcAddress(
                        engine, "__CVI_Resource_Acquire");
                NiFpga_releaseCviResource =
                    (NiFpga_ReleaseCviResource)GetProcAddress(
                        engine, "__CVI_Resource_Release");
