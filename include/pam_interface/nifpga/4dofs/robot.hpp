...
const int STAND_PRESSURES[8] = {16000,15500,13500,12000,16000,15500,14000,12000};

const double ENCODER_MULTIPLIERS[4] = {0.03629032,0.07258065,0.07258065,0.07758621};
...
const uint32_t ENCODERS[4] = {NiFpga_interfaceNewRobotallMuscles_IndicatorI32_q1,
...
const uint32_t CURRENT_PRESSURES[8] = { NiFpga_interfaceNewRobotallMuscles_IndicatorI16_pr0,
...
const uint32_t SET_PRESSURES[8] = { NiFpga_interfaceNewRobotallMuscles_ControlI16_set0,
...
const uint32_t CONTROLS[8] = { NiFpga_interfaceNewRobotallMuscles_ControlBool_Openloop0,
...
const uint32_t MIN_PRESSURES[8] = { NiFpga_interfaceNewRobotallMuscles_ControlI16_min0,
...
const uint32_t MAX_PRESSURES[8] = { NiFpga_interfaceNewRobotallMuscles_ControlI16_max0,
